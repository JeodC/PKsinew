...
class AchievementNotification:
    ...
    def __init__(self, screen_width):
        ...
        # Fonts
        try:
            self.font_title = pygame.font.Font("fonts/Pokemon_GB.ttf", 12)
            self.font_text = pygame.font.Font("fonts/Pokemon_GB.ttf", 9)
            self.font_sinew = pygame.font.Font("fonts/Pokemon_GB.ttf", 24)
        except:
...
class AchievementsScreen:
    ...
    def __init__(self, width, height, game_filter=None, get_current_game_callback=None):
        ...
        try:
            ...
            self.font_sinew = pygame.font.Font("fonts/Pokemon_GB.ttf", 16)
        except:
