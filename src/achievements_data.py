...
ACHIEVEMENT_REWARDS = {
    ...
    "SINEW_033": {
        "type": "both",
        "theme": "GB classic.json",
        "pokemon_achievement": "SINEW_033",
        "theme_name": "GB Classic",
        "pokemon_name": "Celebi",
    },  # Complete 1 Regional Dex
    "SINEW_030": {
        "type": "both",
        "theme": "Champion Gold.json",
        "pokemon_achievement": "SINEW_030",
        "theme_name": "Champion Gold",
        "pokemon_name": "Jirachi",
    },  # Champion in All 5 Games
    "SINEW_008": {
        "type": "both",
        "theme": "Mew.json",
        "pokemon_achievement": "SINEW_008",
        "theme_name": "Mew",
        "pokemon_name": "Mew",
    },  # Sinew Dex: 300 Pokemon
    "SINEW_035": {
        "type": "pokemon",
        "pokemon_achievement": "SINEW_035",
        "name": "Shiny Mew",
    },  # Complete All 5 Regional Dexes
    # NEW Legendary Pokemon rewards
    "SINEW_049": {
        "type": "pokemon",
        "pokemon_achievement": "SINEW_049",
        "name": "Ho-Oh",
    },  # Own Legendary Birds (NEW)
    "SINEW_051": {
        "type": "pokemon",
        "pokemon_achievement": "SINEW_051",
        "name": "Lugia",
    },  # Own Weather Trio
    "SINEW_104": {
        "type": "pokemon",
        "pokemon_achievement": "SINEW_104",
        "name": "Deoxys",
    },  # Dirty Dex: Catch 'Em All! (386 Pokemon)
    # Theme-only rewards - UNCHANGED (before legendaries section)
    "SINEW_027": {
        "type": "theme",
        "value": "Ash Ketchum.json",
        "name": "Ash Ketchum",
    },  # Become Champion Once
    "SINEW_037": {
        "type": "theme",
        "value": "Team Rocket.json",
        "name": "Team Rocket",
    },  # Earn 500,000 Total Money
    "SINEW_041": {
        "type": "theme",
        "value": "Retro CRT.json",
        "name": "Retro CRT",
    },  # Play for 50 Hours Total
    "SINEW_042": {
        "type": "theme",
        "value": "Midnight Terminal.json",
        "name": "Midnight Terminal",
    },  # Play for 100 Hours Total
    "SINEW_005": {
        "type": "theme",
        "value": "Safari Zone.json",
        "name": "Safari Zone",
    },  # Sinew Dex: 150 Pokemon
    # Theme-only rewards - SHIFTED +1 (after legendaries section)
    "SINEW_063": {
        "type": "theme",
        "value": "Glitchcore.json",
        "name": "Glitchcore",
    },  # Dev Mode Discovered! (was 062)
    "SINEW_064": {
        "type": "theme",
        "value": "Prototype Debug.json",
        "name": "Prototype Debug",
    },  # Debug Tester! (was 063)
    "SINEW_094": {
        "type": "theme",
        "value": "Space Station.json",
        "name": "Space Station",
    },  # Store 100 Pokemon (was 093)
    "SINEW_100": {
        "type": "theme",
        "value": "Gengar.json",
        "name": "Gengar",
    },  # Evolve 5 Pokemon (was 099)
}
...
PERGAME_ACHIEVEMENT_REWARDS = {
    "_021": {
        ...
        "value": "Brock.json",
        "name": "Brock",
    },  # First Badge (any game)
    "_028": {
        "type": "unlock",
        "value": "events",
        "name": "Events Access",
    },  # Pokemon Champion! - unlocks Events menu
    "_044": {
        "type": "theme",
        "value": "Pikachu.json",
        "name": "Pikachu",
    },  # First Level 50 (any game)
}
...
GAME_SPECIFIC_REWARDS = {
    "FR_009": {
        ...
        "value": "Misty.json",
        "name": "Misty",
    },  # Kanto Dex Complete (FireRed)
    "LG_009": {
        "type": "theme",
        "value": "Misty.json",
        "name": "Misty",
    },  # Kanto Dex Complete (LeafGreen)
    "FR_076": {
        "type": "theme",
        "value": "Mewtwo.json",
        "name": "Mewtwo",
    },  # Caught Mewtwo! (FireRed)
    "LG_076": {
        "type": "theme",
        "value": "Mewtwo.json",
        "name": "Mewtwo",
    },  # Caught Mewtwo! (LeafGreen)
    ...
    "FR_057": {
        ...
        "value": "events",
        "name": "Events Access",
    },  # Sevii Pokemon Ranger unlocks Events in FireRed
    "LG_057": {
        "type": "unlock",
        "value": "events",
        "name": "Events Access",
    },  # Sevii Pokemon Ranger unlocks Events in LeafGreen
}
...
def _generate_game_achievements(game: str, start_idx: int = 1) -> List[Dict]:
    ...
    achs.append(
        {
            "id": f"{prefix}_{idx:03d}",
            "name": f"{regional_name} Dex Complete",
    ...
    level_achs = [
        (
            "First Level 10",
            "any_pokemon_level >= 10",
            5,
            "Raise a Pokemon to level 10.",
        ),
        (
            "First Level 20",
            "any_pokemon_level >= 20",
            10,
            "Raise a Pokemon to level 20.",
        ),
        (
            "First Level 30",
            "any_pokemon_level >= 30",
            15,
            "Raise a Pokemon to level 30.",
        ),
        (
            "First Level 50",
            "any_pokemon_level >= 50",
            25,
            "Raise a Pokemon to level 50.",
        ),
        (
            "First Level 70",
            "any_pokemon_level >= 70",
            35,
            "Raise a Pokemon to level 70.",
        ),
        (
            "First Level 100!",
            "any_pokemon_level >= 100",
            75,
            "Raise a Pokemon to level 100!",
        ),
        (
            "3 Pokemon Lv30+",
            "pokemon_over_30 >= 3",
            20,
            "Have 3 Pokemon at level 30 or higher.",
        ),
        (
            "6 Pokemon Lv30+",
            "pokemon_over_30 >= 6",
            30,
            "Have 6 Pokemon at level 30 or higher.",
        ),
        (
            "3 Pokemon Lv50+",
            "pokemon_over_50 >= 3",
            35,
            "Have 3 Pokemon at level 50 or higher.",
        ),
        (
            "6 Pokemon Lv50+",
            "pokemon_over_50 >= 6",
            50,
            "Have 6 Pokemon at level 50 or higher.",
        ),
        (
            "3 Pokemon Lv70+",
            "pokemon_over_70 >= 3",
            50,
            "Have 3 Pokemon at level 70 or higher.",
        ),
        (
            "6 Pokemon Lv70+",
            "pokemon_over_70 >= 6",
            75,
            "Have 6 Pokemon at level 70 or higher.",
        ),
        (
            "Full Lv100 Team",
            "pokemon_at_100 >= 6",
            150,
            "Have a full party of level 100 Pokemon!",
        ),
        (
            "10 Pokemon Lv50+",
            "pokemon_over_50 >= 10",
            60,
            "Have 10 Pokemon at level 50 or higher.",
        ),
        (
            "20 Pokemon Lv50+",
            "pokemon_over_50 >= 20",
            100,
            "Have 20 Pokemon at level 50 or higher.",
        ),
    ]
    ...
    if is_frlg:
        party_pc_achs = [
            (
                ...
                "party_size >= 1",
                5,
                "Have at least 1 Pokemon in your party.",
            ),
            (
                "Sevii Pokemon Ranger",
                "has_national_dex AND has_rainbow_pass",
                100,
                "Get the National Dex and Rainbow Pass.",
            ),
            ...
            (
                ...
                "pc_pokemon >= 100",
                50,
                "Store 100 Pokemon in your PC.",
            ),
            (
                "PC Storage: 200",
                "pc_pokemon >= 200",
                75,
                "Store 200 Pokemon in your PC.",
            ),
            (
                "PC Storage: 300",
                "pc_pokemon >= 300",
                100,
                "Store 300 Pokemon in your PC.",
            ),
            (
                "PC Storage: 400",
                "pc_pokemon >= 400",
                150,
                "Store 400 Pokemon in your PC!",
            ),
            (
                "Total Pokemon: 50",
                "total_pokemon >= 50",
                25,
                "Own 50 total Pokemon (party + PC).",
            ),
            (
                "Total Pokemon: 100",
                "total_pokemon >= 100",
                40,
                "Own 100 total Pokemon (party + PC).",
            ),
            (
                "Total Pokemon: 200",
                "total_pokemon >= 200",
                75,
                "Own 200 total Pokemon (party + PC).",
            ),
            (
                "Total Pokemon: 300",
                "total_pokemon >= 300",
                100,
                "Own 300 total Pokemon (party + PC).",
            ),
            (
                "Total Pokemon: 400",
                "total_pokemon >= 400",
                150,
                "Own 400 total Pokemon (party + PC)!",
            ),
        ]
    else:
        party_pc_achs = [
    ...
    remaining_achs = [
        (
            ...
            "dex_seen >= 350",
            50,
            "See 350 different Pokemon species.",
        ),
        (
            "See Them All!",
            "dex_seen >= 386",
            100,
            "See all 386 Pokemon in the National Dex!",
        ),
        ...
        (
            ...
            "playtime_hours >= 150",
            100,
            "Play for 150 hours. A true trainer!",
        ),
        ...
        (
            ...
            "playtime_hours >= 300",
            200,
            "Play for 300 hours. Legendary dedication!",
        ),
        ...
        (
            ...
            "pokemon_over_50 >= 30",
            125,
            "Have 30 Pokemon at level 50 or higher.",
        ),
        (
            "Massive Collection",
            "total_pokemon >= 350",
            175,
            "Own 350 total Pokemon (party + PC).",
        ),
        ...
        (
            ...
            "pc_pokemon >= 420",
            200,
            "Store 420 Pokemon - almost full PC!",
        ),
        ...
        (
            ...
            "pokemon_over_50 >= 40",
            150,
            "Have 40 Pokemon at level 50 or higher.",
        ),
        (
            "50 Pokemon Lv50+",
            "pokemon_over_50 >= 50",
            200,
            "Have 50 Pokemon at level 50 or higher!",
        ),
        (
            "First Level 40",
            "any_pokemon_level >= 40",
            20,
            "Raise a Pokemon to level 40.",
        ),
        (
            "First Level 60",
            "any_pokemon_level >= 60",
            30,
            "Raise a Pokemon to level 60.",
        ),
        (
            "First Level 80",
            "any_pokemon_level >= 80",
            45,
            "Raise a Pokemon to level 80.",
        ),
    ]
    ...
    assert (
        len(achs) == 100
    ), f"{game} generated {len(achs)} achievements (expected 100)."
    return achs
...
def _generate_sinew_achievements(start_idx: int = 1) -> List[Dict]:
    ...
    legendaries = [
        (
            ...
            "owns_species_383",
            50,
            "Catch or obtain Groudon across any save.",
        ),
        (
            "Own Kyogre",
            "owns_species_382",
            50,
            "Catch or obtain Kyogre across any save.",
        ),
        (
            "Own Rayquaza",
            "owns_species_384",
            75,
            "Catch or obtain Rayquaza across any save.",
        ),
        (
            "Own Mewtwo",
            "owns_species_150",
            75,
            "Catch or obtain Mewtwo across any save.",
        ),
        ("Own Mew", "owns_species_151", 100, "Obtain the mythical Mew!"),
        (
            "Own Latios or Latias",
            "owns_species_380_or_381",
            40,
            "Catch a Lati@s across any save.",
        ),
        (
            "Own Legendary Birds",
            "owns_legendary_birds",
            125,
            "Own Articuno, Zapdos, and Moltres!",
        ),
        (
            "Own the Regi Trio",
            "owns_regi_trio",
            100,
            "Own Regirock, Regice, and Registeel.",
        ),
        (
            "Own Weather Trio",
            "owns_weather_trio",
            150,
            "Own Groudon, Kyogre, and Rayquaza.",
        ),
    ...
    trainers = [
        (
            ...
            "global_champions >= 4",
            100,
            "Become Champion in 4 different games.",
        ),
        (
            "Badge Collector: 10",
            "global_badges >= 10",
            20,
            "Collect 10 badges across all saves.",
        ),
        (
            "Badge Collector: 20",
            "global_badges >= 20",
            30,
            "Collect 20 badges across all saves.",
        ),
        (
            "Badge Collector: 28",
            "global_badges >= 28",
            40,
            "Collect 28 badges across all saves.",
        ),
        (
            "Badge Collector: 36",
            "global_badges >= 36",
            75,
            "Collect 36 badges across all saves.",
        ),
        (
            "Halfway Hero x2",
            "games_with_4plus_badges >= 2",
            25,
            "Have 4+ badges in 2 different games.",
        ),
        (
            "Halfway Hero x4",
            "games_with_4plus_badges >= 4",
            50,
            "Have 4+ badges in 4 different games.",
        ),
        (
            "Halfway Hero x5",
            "games_with_4plus_badges >= 5",
            75,
            "Have 4+ badges in ALL 5 games.",
        ),
        (
            "Pokemon Millionaire",
            "global_money >= 5000000",
            100,
            "Accumulate 5 million total money.",
        ),
        (
            "Dev Mode Discovered!",
        ...
        (
            "Debug Tester!",
            "debug_test_activated == True",
            25,
            "Trigger the debug test in Dev Mode!",
        ),
    ]
    ...
    explorations = [
        (
            "Dedicated Trainer: 25h",
            "global_playtime >= 25",
            20,
            "Play for 25 hours total across all saves.",
        ),
        (
            "Veteran Trainer: 75h",
            "global_playtime >= 75",
            40,
            "Play for 75 hours total across all saves.",
        ),
        (
            "Pokemon Master: 150h",
            "global_playtime >= 150",
            75,
            "Play for 150 hours total. True dedication!",
        ),
        (
            "Pokemon Legend: 250h",
            "global_playtime >= 250",
            100,
            "Play for 250 hours total!",
        ),
        (
            "PC Hoarder: 50",
            "global_pc_pokemon >= 50",
            20,
            "Store 50 Pokemon in PC boxes across saves.",
        ),
        (
            "PC Hoarder: 150",
            "global_pc_pokemon >= 150",
            40,
            "Store 150 Pokemon in PC boxes across saves.",
        ),
        (
            "PC Hoarder: 300",
            "global_pc_pokemon >= 300",
            60,
            "Store 300 Pokemon in PC boxes across saves.",
        ),
        (
            "Shiny Hunter: 3",
            "global_shiny_pokemon >= 3",
            50,
            "Own 3 shiny Pokemon across all saves.",
        ),
        (
            "Shiny Hunter: 10",
            "global_shiny_pokemon >= 10",
            100,
            "Own 10 shiny Pokemon across all saves.",
        ),
        (
            "Shiny Hunter: 25",
            "global_shiny_pokemon >= 25",
            200,
            "Own 25 shiny Pokemon. Incredible luck!",
        ),
    ]
    ...
    items = [
        (
            "Level 100 Club",
            "global_level100_pokemon >= 1",
            25,
            "Raise a Pokemon to level 100.",
        ),
        (
            "Level 100 Team",
            "global_level100_pokemon >= 6",
            50,
            "Have 6 Pokemon at level 100.",
        ),
        (
            "Level 100 Squad",
            "global_level100_pokemon >= 12",
            75,
            "Have 12 Pokemon at level 100!",
        ),
        (
            "Level 100 Army",
            "global_level100_pokemon >= 20",
            100,
            "Have 20 Pokemon at level 100!",
        ),
        (
            "Level 100 Legion",
            "global_level100_pokemon >= 50",
            200,
            "Have 50 Pokemon at level 100!!",
        ),
        (
            "Strong Team: 10",
            "global_level50plus_pokemon >= 10",
            15,
            "Have 10 Pokemon at level 50+.",
        ),
        (
            "Strong Team: 30",
            "global_level50plus_pokemon >= 30",
            30,
            "Have 30 Pokemon at level 50+.",
        ),
        (
            "Strong Team: 50",
            "global_level50plus_pokemon >= 50",
            50,
            "Have 50 Pokemon at level 50+.",
        ),
        (
            "Strong Team: 100",
            "global_level50plus_pokemon >= 100",
            75,
            "Have 100 Pokemon at level 50+!",
        ),
        (
            "Full Party x5",
            "global_full_parties >= 5",
            40,
            "Have a full party of 6 in all 5 games.",
        ),
    ]
    ...
    stats = [
        (
            "Full Party x1",
            "global_full_parties >= 1",
            10,
            "Have 6 Pokemon in any save's party.",
        ),
        (
            "Full Party x3",
            "global_full_parties >= 3",
            25,
            "Have full parties in 3 different games.",
        ),
        (
            "Starter Squad",
            "global_starters >= 2",
            20,
            "Own Pokemon from 2 different starter lines.",
        ),
        (
            "Starter Collector",
            "global_starters >= 4",
            40,
            "Own Pokemon from 4 different starter lines.",
        ),
        (
            "All Starters",
            "global_starters >= 6",
            100,
            "Own Pokemon from all 6 starter lines!",
        ),
        (
            "Eeveelution Fan",
            "global_eeveelutions >= 3",
            40,
            "Own 3 different Eeveelutions.",
        ),
        (
            "Eeveelution Master",
            "global_eeveelutions >= 5",
            75,
            "Own all 5 Gen 1-3 Eeveelutions!",
        ),
    ]
    ...
    dirty_dex = [
        (
            "Dirty Dex: 100 Species",
            "combined_pokedex >= 100",
            50,
            "Own 100 unique species across all your save files.",
        ),
        (
            "Dirty Dex: 250 Species",
            "combined_pokedex >= 250",
            75,
            "Own 250 unique species across all your save files.",
        ),
        (
            "Dirty Dex: Catch 'Em All!",
            "combined_pokedex >= 386",
            500,
            "Own all 386 Pokemon across your combined saves! True Pokemon Master!",
        ),
    ]
    ...
    event_items = [
        (
            "Southern Island Pass",
            "event_eon_ticket_claimed",
            "Obtain the Eon Ticket to visit Southern Island.",
            25,
        ),
        (
            "Birth Island Pass",
            "event_aurora_ticket_claimed",
            "Obtain the Aurora Ticket to visit Birth Island.",
            25,
        ),
        (
            "Navel Rock Pass",
            "event_mystic_ticket_claimed",
            "Obtain the Mystic Ticket to visit Navel Rock.",
            25,
        ),
        (
            "Faraway Island Pass",
            "event_old_sea_map_claimed",
            "Obtain the Old Sea Map to visit Faraway Island.",
            25,
        ),
    ]
    ...
    assert (
        len(achs) >= 100
    ), f"Sinew generated {len(achs)} achievements (expected at least 100)."
    return achs
...
def check_achievement_unlocked(
    ach: Dict, save_data: Dict, all_saves: List[Dict] = None
) -> bool:
    """
